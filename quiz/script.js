...
continue_btn.onclick = () => {
    ...
    startTimer(10); //call ing startTimer function
...
function Casenotanswerthequestion() {
    if (timeValue == 0) {
        alert("Reiniciando.....Tente ser mais rapido da proxima,meu consagrado!!");
        //mostrar a caixa para reiniciar apos demorar demais, mas acho que precisa criar outra caixinha para tal coisa acontecer
